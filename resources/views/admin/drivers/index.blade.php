                 ...
                 <div class="d-flex align-items-center gap-2 gap-lg-3">
                     ...
                     @can('create drivers')
                         <a class="btn btn-sm fw-bold btn-primary"
                             href="{{ route('admin.drivers.create') }}">{{ __('messages.create_driver') }}</a>
                     @endcan
                 </div>
             </div>
         </div>
                                     ...
                                     @foreach ($drivers as $key => $driver)
                                         <tr>
                                             <td data-kt-ecommerce-order-filter="order_id">
                                                 <a
                                                     href="{{ route('admin.drivers.show', $driver->id) }}">#{{ ++$key }}</a>
                                             </td>
                                             <td>
                                                 <div class="d-flex align-items-center">
                                                     ...
                                                     <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                         <a>
                                                             <div class="symbol-label">
                                                                 <img src="{{ asset($driver->image) }}" alt="Emma Smith"
                                                                     class="w-100" />
                                                             </div>
                                                         </a>
                                                     </div>
                                                     ...
                                                     <div class="ms-5">
                                                         <!--begin::Title-->
                                                         <a
                                                             class="text-gray-800 text-hover-primary fs-5 fw-bold">{{ $driver->name }}</a>
                                                         <!--end::Title-->
                                                     </div>
                                                 </div>
                                             </td>
                                             ...
                                             <td class="">
                                                 ...
                                                 <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                     ...
                                                     @can('delete drivers')
                                                         <div class="menu-item px-3">
                                                             <form action="{{ route('admin.drivers.delete', $driver->id) }}"
                 ...
                 <div class="modal-content">
                     ...
                     <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                         ...
                         <form id="kt_modal_add_user_form" class="form form-ajax fv-plugins-bootstrap5 fv-plugins-framework"
                             action="{{ route('admin.drivers.store') }}" method="post" enctype="multipart/form-data">
                             @csrf
                             <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                                 ...
                                 <div class="fv-row mb-7">
                                     ...
                                     <div class="image-input image-input-outline image-input-placeholder"
                                         ...
                                         <div class="image-input-wrapper w-125px h-125px"
                                             style="background-image: url({{ asset('static/images/300-29.jpg') }});">
                                         </div>
                                 ...
                                 <div class="fv-row mb-7 fv-plugins-icon-container">
                                     ...
                                     <input type="text" name="name"
                                         class="form-control form-control-solid mb-3 mb-lg-0" pattern="[A-Za-z\s]+"
                                         title="Only letters are allowed" placeholder="{{ __('messages.Full_name') }}"
                                         value="" required="">
