	...
	<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
		<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
			<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
				<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">{{__('messages.Admins')}}</h1>
			...
			<div class="d-flex align-items-center gap-2 gap-lg-3">
				...
				<a href="#" class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user">{{__('messages.Create')}}</a>
			</div>
		</div>
	</div>
						...
						<tbody class="fw-semibold text-gray-600">
							...
							<tr>
								<td data-kt-ecommerce-order-filter="order_id">
									<a href="{{ route('admin.profile', ['id' => $admin->id, 'model' => 'admin']) }}">
										#{{ $admin->id }}
									</a>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
											<a>
												<div class="symbol-label">
													<img src="{{asset($admin->image)}}" alt="Emma Smith" class="w-100" />
												</div>
											</a>
										</div>
										<!--end::Avatar-->
										<div class="ms-5">
											<!--begin::Title-->
											<a class="text-gray-800 text-hover-primary fs-5 fw-bold">{{$admin->name}}</a>
											<!--end::Title-->
										</div>
									</div>
								</td>
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
										...
										<div class="menu-item px-3">
											<a  data-bs-toggle="modal"
											 onclick="editData(
											 '{{$admin->id}}','{{$admin->name}}','{{$admin->image}}','{{$admin->email}}',
											 '{{$roleId}}','{{$admin->phone}}'
											 )" 
											 data-bs-target="#kt_modal_edit_user" class="menu-link px-3">{{__("messages.Edit")}}</a>
										</div>
										<div class="menu-item px-3">
											<form action="{{route('admin.admins.delete',$admin->id)}}" id="delete-form" method="post">
												@csrf
		...
		<div class="modal-dialog modal-dialog-centered mw-650px">
			...
			<div class="modal-content">
				...
				<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
					<!--begin::Form-->
					<form id="kt_modal_add_user_form" class="form form-ajax fv-plugins-bootstrap5 fv-plugins-framework" action="{{route('admin.admins.store')}}" method="post" enctype="multipart/form-data">
						@csrf
	...
	<div class="modal fade" id="kt_modal_edit_user" tabindex="-1" style="display: none;" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered mw-650px">
			<div class="modal-content">
				...
				<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
					<!--begin::Form-->
					<form id="kt_modal_add_user_form" class="form form-ajax fv-plugins-bootstrap5 fv-plugins-framework" action="{{route('admin.admins.update')}}" method="post" enctype="multipart/form-data">
						@csrf
