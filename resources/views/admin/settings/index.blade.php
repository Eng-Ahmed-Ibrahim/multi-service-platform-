            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    <li class="breadcrumb-item text-muted">
                        <a href="../../demo1/dist/index.html" class="text-muted text-hover-primary">{{__('messages.Settings')}}</a>
                    </li>
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x border-transparent fs-4 fw-semibold mb-15" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link text-active-primary d-flex align-items-center  {{session('settings_tab') ==1 ?' active' : ' ' }} pb-5 " data-bs-toggle="tab" href="#general" aria-selected="true" role="tab">
                        ...
                        <!--begin:::Tab item-->
                        <li class="nav-item" role="presentation">
                            <a class="nav-link text-active-primary d-flex align-items-center  {{session('settings_tab') ==2 ?' active' : ' ' }}  pb-5 " data-bs-toggle="tab" href="#Privacy" aria-selected="true" role="tab">
                                <!-- <i class="ki-duotone ki-home fs-2 me-2"></i> -->
                                {{__('messages.Privacy')}}
                            </a>
                        </li>
                        <!--begin:::Tab item-->
                        <li class="nav-item" role="presentation">
                            <a class="nav-link text-active-primary d-flex align-items-center  {{session('settings_tab') ==3 ?' active' : ' ' }}  pb-5 " data-bs-toggle="tab" href="#Policy" aria-selected="true" role="tab">
                                <!-- <i class="ki-duotone ki-home fs-2 me-2"></i> -->
                                {{__('messages.Policy')}}
                            </a>
                        </li>
                    ...
                    <div class="tab-content" id="myTabContent" data-select2-id="select2-data-myTabContent">
                        ...
                        <!--begin:::Tab General-->
                        <div class="tab-pane fade {{session('settings_tab') ==1 ?'show active' : ' ' }}" id="general" role="tabpanel" data-select2-id="select2-data-general">
                            <form action="{{route('admin.settings.update')}}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-sm-12 mb-3">
                                        <label for="formGroupExampleInput" class="form-label">{{__("messages.Price_per_kilometer")}}</label>
                                        <input type="text" value="{{  $settings->where('key', 'price_per_kilometer')->first()->value }}" class="form-control" id="formGroupExampleInput" name="values[]" placeholder="{{__('messages.Price_per_kilometer')}}">
                                    </div>
                                    <div class="col-lg-6 col-sm-12 mb-3">
                                        <label for="formGroupExampleInput" class="form-label">{{__("messages.minimum_wallet_balance")}}</label>
                                        <input type="text" value="{{  $settings->where('key', 'minimum_wallet_balance')->first()->value }}" class="form-control" id="formGroupExampleInput" name="values[]" placeholder="{{__('messages.minimum_wallet_balance')}}">
                                    </div>
                                </div>
                        ...
                        <!--begin:::Tab Privacy-->
                        <div class="tab-pane fade  {{session('settings_tab') ==2 ?'show active' : ' ' }} " id="Privacy" role="tabpanel" data-select2-id="select2-data-general">
                            <form action="{{route('admin.settings.update')}}" method="post">
                                @csrf
                        ...
                        <!-- End :: Tab Privacy -->
                        <!--begin:::Tab Policy-->
                        <div class="tab-pane fade  {{session('settings_tab') ==3 ?'show active' : ' ' }}" id="Policy" role="tabpanel" data-select2-id="select2-data-general">
                            <form action="{{route('admin.settings.update')}}" method="post">
                                @csrf
