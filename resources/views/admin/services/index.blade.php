...
<div class="d-flex flex-column flex-column-fluid">
	<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
		<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
			...
			<div class="d-flex align-items-center gap-2 gap-lg-3">
				...
				@php
				$permissionsMap = [
				'home_services' => 'add home services',
				'car_services' => 'add car services',
				'car_transportations' => 'add car transportations',
				];
				@endphp

				@if(isset($permissionsMap[$section]) && Auth::guard('admin')->user()->can($permissionsMap[$section]))
				<a class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user">
					{{ __('messages.Create') }}
				</a>
				@endif
			...
			<div class="card">
				...
				<div id="" class="table-responsive">
					...
					<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
						@php
						$permissionsMap = [
						'home_services' => ['edit home services', 'delete home services'],
						'car_services' => ['edit car services', 'delete car services'],
						'car_transportations' => ['edit car transportations', 'delete car transportations'],
						];
						@endphp
						<thead>
							<tr class=" text-gray-400 fw-bold fs-7 text-uppercase gs-0">
								...
								<th class="min-w-175px">{{__('messages.Commission')}}%</th>
								<th class="min-w-175px">{{__('messages.Image')}}</th>
								<th class="min-w-175px">{{__('messages.Status')}}</th>

								@if(isset($permissionsMap[$section]) && \App\Helpers\Helpers::hasAnyPermission(Auth::guard('admin')->user(), $permissionsMap[$section]))
						...
						<tbody class="fw-semibold text-gray-600">
							...
							<tr>
								<td data-kt-ecommerce-order-filter="order_id">
									@if($section=="car_transportations")
									<a href="{{route('admin.services.brands',$service->id)}}">#{{++$key}}</a>
									@else
									#{{++$key}}
									@endif
								</td>
								...
								<td >
									<span class="fw-bold">{{session('lang')=="en" ? $service->name : $service->name_ar}}</span>
								</td>
								<td>{{$service->commission}}%</td>
								<td><img src="{{asset($service->image)}}" style="height:60px" alt=""></td>
								<td>
									<form action="{{route('admin.services.update_status')}}" id="status-form" method="post">
										@csrf
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
										<div class="menu-item px-3">
											<a data-bs-toggle="modal"
												onclick="editData('{{$service->id}}','{{$service->name}}','{{$service->name_ar}}','{{$service->image}}','{{$service->commission}}')"
		...
		<div class="modal-dialog modal-dialog-centered mw-650px">
			...
			<div class="modal-content">
				...
				<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
					<!--begin::Form-->
					<form id="kt_modal_add_user_form" class="form form-ajax fv-plugins-bootstrap5 fv-plugins-framework" action="{{route('admin.services.store')}}" method="post" enctype="multipart/form-data">
						@csrf
						...
						<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px" style="">
							...
							<div class="row">
								...
								<div class="col-12 mb-2">
									<label class="required fw-semibold fs-6 mb-2">{{__("messages.Commission")}}%</label>
									<input type="number" name="commission" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="{{__('messages.Commission')}}%" value="" required="">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>
							</div>
	...
	<div class="modal fade" id="kt_modal_edit_user" tabindex="-1" style="display: none;" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered mw-650px">
			<div class="modal-content">
				...
				<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
					<!--begin::Form-->
					<form id="kt_modal_add_user_form" class="form form-ajax fv-plugins-bootstrap5 fv-plugins-framework" action="{{route('admin.services.update')}}" method="post" enctype="multipart/form-data">
						@csrf
						<input type="text" hidden name="service_id" id="edit-service-id">
						<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px" style="">
							...
							<div class="row">
								...
								<div class="col-12 mb-2">
									<label class="required fw-semibold fs-6 mb-2">{{__("messages.Commission")}}%</label>
									<input type="number" id="edit-commission" name="commission" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="{{__('messages.Commission')}}%" required="">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>
							</div>
	...
	@section("js")
	<script>
		function editData(id, name, name_ar, image, commission) {
