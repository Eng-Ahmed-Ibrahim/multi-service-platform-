		...
		<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
			<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
				...
				<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
					...
					<li class="breadcrumb-item text-muted">{{__("messages.Models")}}</li>
				</ul>
			</div>
						...
						<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
							...
							<tbody class="fw-semibold text-gray-600">
								...
								<tr>
									...
									<td class="">
										<span class="fw-bold">{{session('lang')=="en"? $model->name : $model->name_ar}}</span>
									</td>
									<td><img src="{{asset($model->image)}}" style="height:60px" alt=""></td>
									<td>
										<form action="{{route('admin.services.model.update_status')}}" id="status-form" method="post">
											@csrf
										...
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
											<div class="menu-item px-3">
												<a data-bs-toggle="modal"
													onclick="editData('{{$model->id}}','{{$model->name}}','{{$model->name_ar}}','{{$model->image}}')"
													data-bs-target="#kt_modal_edit_user" class="menu-link px-3">{{__("messages.Edit")}}</a>
											</div>
											<div class="menu-item px-3">
												<form action="{{route('admin.services.model.delete',$model->id)}}" id="delete-form" method="post">
													@csrf
		...
		<div class="modal-dialog modal-dialog-centered mw-650px">
			...
			<div class="modal-content">
				...
				<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
					<!--begin::Form-->
					<form id="kt_modal_add_user_form" class="form form-ajax fv-plugins-bootstrap5 fv-plugins-framework" action="{{route('admin.services.model.store')}}" method="post" enctype="multipart/form-data">
						@csrf
						<input type="hidden" name="brand_id" value="{{$service->id}}">
	...
	<div class="modal fade" id="kt_modal_edit_user" tabindex="-1" style="display: none;" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered mw-650px">
			<div class="modal-content">
				...
				<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
					<!--begin::Form-->
					<form id="kt_modal_add_user_form" class="form form-ajax fv-plugins-bootstrap5 fv-plugins-framework" action="{{route('admin.services.model.update')}}" method="post" enctype="multipart/form-data">
						@csrf
						<input type="text" hidden name="model_id" id="edit-model-id">
						<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px" style="">
