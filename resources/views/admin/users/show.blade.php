    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">{{$user->name}}</h1>
                    ...
                    <div class="card-body pt-15">
                        ...
                        <div class="d-flex flex-center flex-column mb-5">
                            ...
                            <div class="symbol symbol-100px symbol-circle mb-7">
                                <img src="{{asset($user->image)}}" alt="image" data--h-bstatus="4PROCESSING" class="hb-hide-temp">
                            </div>
                            <!--end::Avatar-->
            ...
            <div class="flex-lg-row-fluid ms-lg-15">
                ...
                <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#kt_customer_view_overview_tab" aria-selected="true" role="tab">{{__("messages.Requests")}}</a>
                    </li>
                    <!--end:::Tab item-->
                </ul>
                <!--end:::Tabs-->
